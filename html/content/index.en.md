...
| 7-9 | Platform components (Kubernetes internal structure, usage and extension APIs, scheduler, operators, CNI, CSI, intra-platform networking, Edge integration) [[CRI, CNI, CSI slides](https://docs.google.com/presentation/d/143pYlJpSSmAO3VMlkR0xCIz4Ik5WEBgUoH-T9BS_-YE/edit?usp=sharing)] [[CRD example](https://github.com/chazapis/hy548/tree/master/crds)] [[webhook example](https://github.com/chazapis/hy548/tree/master/webhooks)] |
